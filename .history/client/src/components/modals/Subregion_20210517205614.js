	...
	return (
		...
		<div class="subRegionViewer">
            ...
            }
            {
                editingStatus?
                        <input
                            className='table-select regionLeader' onBlur={handleStatusEdit}
                            autoFocus={true} defaultValue={""} type='text'
                            wType="outlined" barAnimation="solid" inputClass="table-input-class"
                        />
                            : <div className="table-text regionLeader" onClick={() => toggleStatusEdit(!editingStatus)} className={` table-text`}>
